...
public class OperatorConcatMAPExcutorPresentor extends ExcutorPresentor implements IExcutorPresenter.Presenter {
    ...
    public OperatorConcatMAPExcutorPresentor(IExcutorPresenter.View view, Label label) {
        this.view = view;
        this.label = label;
