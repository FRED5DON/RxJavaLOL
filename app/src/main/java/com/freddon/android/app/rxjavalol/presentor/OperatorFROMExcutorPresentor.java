...
public class OperatorFROMExcutorPresentor extends ExcutorPresentor implements IExcutorPresenter.Presenter{
    ...
    public OperatorFROMExcutorPresentor(IExcutorPresenter.View view, Label label) {
        this.view = view;
        this.label = label;
    ...
    public void excute() {
        view.setRxLabelTitle(label.getText());
        view.onShow("开始执行");
        Label[] labels = {label, new Label("HELLO WORD,NOT WORLD!")};
        observable = Observable.from(labels)
    ...
    public String getCode() {
        return "Label[] labels = {label, new Label(\"HELLO WORD,NOT WORLD!\")};\n" +
                "        Observable.from(labels)\n" +
                "                .subscribeOn(Schedulers.io())\n" +
                "                .observeOn(AndroidSchedulers.mainThread())\n" +
                "                .subscribe(new Action1<Label>() {\n" +
                "                    @Override\n" +
