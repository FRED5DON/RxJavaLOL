...
public class OperatorConcatWithExcutorPresentor extends ExcutorPresentor implements IExcutorPresenter.Presenter {
    ...
    public OperatorConcatWithExcutorPresentor(IExcutorPresenter.View view, Label label) {
        this.view = view;
        this.label = label;
